...
class TestModule(object):
    ...
    def imshow_heatmap(self, pr_dec, images):
        ...
        images = np.transpose(
            (images.squeeze(0).data.cpu().numpy() + 0.5) * 255, (1, 2, 0)).astype(np.uint8)
        ...
        for cnt, data_dict in enumerate(data_loader):
            ...
            for cat in dsets.category:
                ...
                for pred in result:
                    ...
                    cv2.line(ori_image, (int(cen_pts[0]), int(cen_pts[1])), (int(
                    ...
                    ori_image = cv2.drawContours(
                        ori_image, [np.int0(box)], -1, (255, 0, 255), 1, 1)
